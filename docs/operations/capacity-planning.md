...
| `hint`    | Applicable only for Windows, where TCP backlog limit is hit. For example, Windows 10 allows a maximum of 200 connections.
Even if the limit is set higher, without hint=true it won't be possible to connect more than 200 connections. |
