...
| cairo.max.uncommitted.rows                     | 500000            | Maximum number of uncommitted rows per table. When the number of pending rows exceeds this parameter for a table, a commit is issued.                                                                                |
