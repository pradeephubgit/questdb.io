...
| http.min.net.connection.timeout | 300000       | Idle connection timeout in milliseconds.                                                                                                                                        |
...
| cairo.max.uncommitted.rows                     | 500000            | Maximum number of uncommitted rows per table. For a given table, when the number of pending rows exceeds this value, a commit is issued.                                                                                |
...
| cairo.sql.map.max.pages                        | 2^31              | Maximum number of pages allocated for CompactMap in memory.                                                                                                                                                                                         |
