...
| pg.connection.pool.capacity      | 64           | Maximum amount of pooled connections for the interface.                                                                                                                                  |
...
| line.tcp.net.bind.to                       | 0.0.0.0:9009 | IP address of the network interface to bind a listener to a port. By default, TCP receiver listens on all network interfaces.                                                                                                                         |
...
| line.tcp.msg.buffer.size                   | 32768        | Size of the buffer read from the queue. Maximum size of write request, regardless of the number of measurements.                                                                                                                                          |
